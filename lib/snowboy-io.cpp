            ...
            *is >> *t;
            ...
            if(c == 4) {
                ...
                SNOWBOY_ERROR() << "Failed to read <float> type in ReadBasicType(): "
                                    "expected float, got instead " << static_cast<int>(c) << " at position " << is->tellg();
                return;
            }
        }
        if(!*is) {
            ...
            *is >> *t;
            ...
            if(c == 4) {
                ...
                SNOWBOY_ERROR() << "Failed to read <int> type in ReadBasicType(): "
                                    "expected int, got instead " << static_cast<int>(c) << " at position " << is->tellg();
                return;
            }
        }
        if(!*is) {
            ...
            *is >> *t;
            ...
            if(c == 8) {
                ...
                SNOWBOY_ERROR() << "Failed to read <long> type in ReadBasicType(): "
                                    "expected long, got instead " << static_cast<int>(c) << " at position " << is->tellg();
                return;
            }
        }
        if(!*is) {
